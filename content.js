...
const blogs = [
  {
    ...
    date: "2026-06-30",
    year: 2026,
    tags: ["systems", "motive", "first post"],
    summary:
      "Two non-negotiables — no one sleeps hungry, and no one sleeps without a smile — and the search for a system that can actually deliver them.",
    body: [
